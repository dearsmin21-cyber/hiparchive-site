...
const reviewItems = [
  ...
  },
  {
    ...
    timeline: "작업 기간 1일",
    amount: "주문 금액 5~10만원",
    text: "생각하던 분위기대로 작업 잘해주셨어요. 곡 무드가 훨씬 또렷하게 살아나서 만족했습니다.",
  },
  {
    author: "union*****",
    rating: "5.0",
    timeline: "작업 기간 1일",
    amount: "주문 금액 5만원 미만",
    text: "예쁘게 잘 만들어주셨어요. 다음에도 또 맡길게요!",
  },
  {
    author: "motive*****",
    rating: "5.0",
    timeline: "작업 기간 2일",
    amount: "주문 금액 5~10만원",
    text: "수정도 정말 빠르게 해주시고 요청사항도 잘 반영해주셨어요. 퀄리티도 좋아서 추천드리고 싶습니다.",
  },
  {
    author: "echo21*****",
    rating: "5.0",
    timeline: "작업 기간 1일",
    amount: "주문 금액 5~10만원",
    text: "좋은 작업물 감사합니다. 원하는 느낌 잘 살려주셔서 만족했습니다.",
  },
];
